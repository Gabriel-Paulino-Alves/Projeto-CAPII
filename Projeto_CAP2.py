...
produtos = [Produto("01", "Whey Isolado DUX", 279.9, 15),
            Produto("02","Tasty ISO Adaptogen", 269.9, 10),
            Produto("03", "Gold Whey", 149.9, 40),
            Produto("04", "Ultra Mass Gainers",99.9,8),
            Produto("05", "Mega Mass Gainers", 99.9, 7),
            Produto("06", "Creatina Pura", 189.9, 75),
            Produto("07", "NO Control Pre Workout", 129.9, 30),
            Produto("08", "Arginina", 139.9, 6),
            Produto("09", "Beta Flexx", 199.90, 4),
